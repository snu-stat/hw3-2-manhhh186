...
Since p<0.05, we reject $H_0: g=0$ at the 5% significance level and conclude that the coefficient k differs significantly between the steroid era and the recent era. The positive estimate $\hat{g} = 0.1616$ indicates that k was larger during the steroid era than during the recent era.
